...
if direction == "left":
    print("You have come to a lake. There is an island in the middle of the lake. Do you want to wait for a boat or swim across?")
    lake = input("Type 'wait' or 'swim': ")
    if lake == "wait":
        print("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow")
        door = input("and one blue. Which colour do you choose? ")
        if door == "red":
